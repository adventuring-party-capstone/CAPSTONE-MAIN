			...
			<div id="created-drinks-container">
				...
				<div id="created-drinks-gallery">
					{drinksToDisplay.map((drink) => {
						...
						return (
							<div key={drink.drinks_id} id="edit-flip-card">
								<div id="edit-flip-card-inner">
									...
									<div id="edit-flip-card-back">
										<div>
											<DetailsButton drinkId={localDrinkId} id="pink-button" />
											<DeleteUserCreatedDrink drinks_id={localDrinkId} />
											<EditUserDrink drinkId={localDrinkId} />
										</div>
									</div>
								</div>
							</div>
